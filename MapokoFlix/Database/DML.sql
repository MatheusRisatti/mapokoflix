...
( 1, 'The Shawshank Redemption', 'Um Sonho de Liberdade', 'Dois homens presos se reúnem ao longo de vários anos, encontrando consolo e eventual redenção através de atos de decência comum.', 1994, 142, 16, '\\img\\movies\\01.jpg'),
( 2, 'The Godfather', 'O Poderoso Chefão', 'O patriarca idoso de uma dinastia do crime organizado transfere o controle de seu império clandestino para seu filho relutante.', 1972, 175, 14, '\\img\\movies\\02.jpg'),
( 3, 'The Dark Knight', 'Batman: O Cavaleiro das Trevas', 'Quando a ameaça conhecida como O Coringa surge de seu passado, causa estragos e caos nas pessoas de Gotham. O Cavaleiro das Trevas deve aceitar um dos maiores testes para combater a injustiça.', 2008, 152, 12, '\\img\\movies\\03.jpg'),
( 4, 'The Godfather Part II', 'O Poderoso Chefão II', 'Em 1950, Michael Corleone, agora à frente da família, tenta expandir o negócio do crime a Las Vegas, Los Angeles e Cuba. Paralelamente, é revelada a história de Vito Corleone, e de como saiu da Sicília e chegou a Nova Iorque.', 1974, 202, 14, '\\img\\movies\\04.jpg'),
( 5, '12 Angry Men', '12 Homens e uma Sentença', 'Um jurado que se aposenta tenta evitar um erro judicial forçando seus colegas a reconsiderarem as evidências.', 1957, 96, 0, '\\img\\movies\\05.jpg'),
( 6, 'Schindler''s List', 'A Lista de Schindler', 'Depois de testemunhar a perseguição dos judaicos na Polônia ocupada pelos alemães durante a Segunda Guerra Mundial, o industrial Oskar Schindler se começa a preocupar com sua força de trabalho judaica.', 1993, 195, 14, '\\img\\movies\\06.jpg'),
( 7, 'The Lord of the Rings: The Return of the King', 'O Senhor dos Anéis: O Retorno do Rei', 'Gandalf e Aragorn lideram o Mundo dos Homens contra o exército de Sauron para desviar o olhar de Frodo e Sam quando eles se aproximam á Montanha da Perdição com o Um Anel.', 2003, 201, 14, '\\img\\movies\\07.jpg'),
( 8, 'Pulp Fiction', 'Pulp Fiction: Tempo de Violência', 'As vidas de dois assassinos da máfia, um boxeador, um gângster e sua esposa, e um par de bandidos se entrelaçam em quatro histórias de violência e redenção.', 1994, 154, 18, '\\img\\movies\\08.jpg'),
( 9, 'The Lord of the Rings: The Fellowship of the Ring', 'O Senhor dos Anéis: A Sociedade do Anel', 'Um manso hobbit do Condado e oito companheiros partem em uma jornada para destruir o poderoso Um Anel e salvar a Terra-média das Trevas.', 2001, 178, 12, '\\img\\movies\\09.jpg'),
